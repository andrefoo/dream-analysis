              ...
              >
                ...
                {analysis && displayedText === analysis.emotional && (
                  <motion.div
                    ...
                    transition={{ delay: 0.5 }}
                  >
                    <p className="text-white font-medium mt-6 mb-3 font-title">Symbolic Elements:</p>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      {analysis.symbolism.map((item, index) => (
                        ...
                        >
                          <h3 className="text-dream-pink font-medium font-title">{item.symbol}</h3>
                          <p className="text-white text-opacity-80 text-sm font-sans">{item.meaning}</p>
                        </motion.div>
                      ))}
                    </div>
                  </motion.div>
                ...
                {analysis && displayedText === analysis.emotional && (
                  ...
                  >
                    <p className="text-dream-pink font-medium mb-2 font-title">Suggested Actions:</p>
                    <p className="text-white text-opacity-90 font-sans">{analysis.advice}</p>
                  </motion.div>
                )}
