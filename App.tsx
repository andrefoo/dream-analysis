    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <TextInput
          ...
          placeholderTextColor="#ffffff80"
        />
        <TouchableOpacity style={styles.button} onPress={continueToDetailed}>
...
type DetailedInputScreenProps = NativeStackScreenProps<
  RootStackParamList,
  "DetailedInput"
>;
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Text style={styles.label}>
          Important symbols or objects in your dream:
        </Text>
        ...
        <Text style={styles.label}>
          Emotional intensity: {emotionalIntensity.toFixed(1)}
        </Text>
        ...
        <Text style={styles.label}>
          How does this dream connect to your current life?
        </Text>
        <TextInput
        ...
        <TouchableOpacity
          style={[
            styles.button,
            (isLoading || !dream || !mood) && styles.buttonDisabled,
          ]}
...
const AnalysisScreen = ({
  ...
  route: { params: AnalysisScreenParams };
}) => {
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {dreamText && (
          <View style={styles.dreamContainer}>
            ...
            {mood && (
              <Text style={styles.dreamMoodLabel}>
                Mood: <Text style={styles.dreamMoodText}>{mood}</Text>
              </Text>
            )}
          </View>
        )}
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            const analysis: Analysis = {
              ...
              advice:
                "Review your dream journal regularly to identify patterns.",
            };
      ...
      <View style={styles.dashboardGrid}>
            ...
            <View>
              {recentDreams.slice(0, 2).map((dream, index) => (
                <View key={dream.id} style={styles.recentDreamItem}>
                  ...
                  <Text style={styles.recentDreamText} numberOfLines={1}>
                    {dream.dream_text}
                  </Text>
                </View>
              ))}
        ...
        <View style={styles.dashboardCard}>
          ...
          <Text style={styles.insightText}>
            Dreams often reflect your subconscious mind processing emotions and
            experiences.
          </Text>

          <Text style={styles.insightText}>
            Regular dream journaling can help identify recurring themes and
            symbols.
          </Text>
        ...
        >
          ...
          <Text style={styles.journalText}>
            Your dream journal helps you track and understand your dream
            patterns over time.
          </Text>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={[styles.navButtonText, { color: "#000010" }]}>
          Gallery
        </Text>
      </TouchableOpacity>
      ...
      >
        ...
        <Text style={[styles.navButtonText, { color: "#f6547b" }]}>
          Add Dream
        </Text>
      </TouchableOpacity>
